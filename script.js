...
if(!isOpen){
    ...
    // Exibir mensagem de sucesso com a forma de pagamento
    const successMessage = document.getElementById("success-message");
    successMessage.textContent = `Pedido enviado com sucesso! Forma de pagamento: ${selectedPayment}.`;
    successMessage.classList.remove("hidden");

    // Limpar o carrinho e o endereço
    cart = [];
    updateCartModal();
    addressInput.value = "";
